...
static void MX_SPI1_Init(void)
{
  ...
  // --- CORRECTIF TECHNIQUE REGISTRE SPI1 ---
    SET_BIT(hspi1.Instance->CR2, SPI_CR2_FRXTH);   // Force le seuil de la FIFO à 8-bit (Quarter Full)
    CLEAR_BIT(hspi1.Instance->CR2, SPI_CR2_NSSP);  // Désactive proprement les impulsions parasites sur le CS
